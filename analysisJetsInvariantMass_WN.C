...
void analysisJetsInvariantMass_WN(int n, double r, double m, int in, int jobs){
...
//    mkdir("OUTPUT/Histograms_Output", S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
    ...
    TFile fout(("OUTPUT_WN/Histograms_Output/"+folder+header+"_hresultsJetsInvariantMass.root").c_str(),"recreate");
