...
void analysisMatchesCharmJets_WN(int n, double r, double m, int in, int jobs){
    ...
    ifstream charmianJets("OUTPUT_WN/"+folder+header+"_charmianJets.out");
    ifstream anticharmianJets("OUTPUT_WN/"+folder+header+"_anticharmianJets.out");
    ifstream strangianJets("OUTPUT_WN/"+folder+header+"_strangianJets.out");
    ifstream antistrangianJets("OUTPUT_WN/"+folder+header+"_antistrangianJets.out");


    ifstream charmsParticles("OUTPUT_WN/"+folder+header+"_charm.out");
    ifstream anticharmsParticles("OUTPUT_WN/"+folder+header+"_anticharm.out");
    ifstream strangesParticles("OUTPUT_WN/"+folder+header+"_strange.out");
    ifstream antistrangesParticles("OUTPUT_WN/"+folder+header+"_antistrange.out");
  ...
  //  mkdir("OUTPUT/Histograms_Output", S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
    ...
    TFile fout(("OUTPUT_WN/Histograms_Output/"+folder+header+"_resultsMatchesCharmJets.root").c_str(),"recreate");
