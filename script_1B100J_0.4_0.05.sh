...
#SBATCH --ntasks=1
#SBATCH --array=1-100
#SBATCH --output=output_10M100J_0.4_0.05_%a.out
#SBATCH --error=errors_10M100J_0.4_0.05_%a.err
...
mv output_10M100J_0.4_0.05_$SLURM_ARRAY_TASK_ID.out logs_1B_0.4_0.05_100/
mv errors_10M100J_0.4_0.05_$SLURM_ARRAY_TASK_ID.err logs_1B_0.4_0.05_100/
