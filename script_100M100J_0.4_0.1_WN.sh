#!/bin/bash
#SBATCH --job-name=CSJets_WN_100M100J_0.4_0.1
#SBATCH -p serial
#SBATCH --time=3-00:00:00
#SBATCH --ntasks=1
#SBATCH --array=1-100
#SBATCH --output=output_WN_1M100J_0.4_0.1_%a.out
#SBATCH --error=errors_WN_1M100J_0.4_0.1_%a.err
...
mkdir -p logs_WN_100M_0.4_0.1_100
mv output_WN_1M100J_0.4_0.1_$SLURM_ARRAY_TASK_ID.out logs_WN_100M_0.4_0.1_100/
