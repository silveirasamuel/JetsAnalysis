...
void analysisJetsQuarksPt_WN(int n, double r, double m, int in, int jobs){
  ...
  //  mkdir("OUTPUT/Histograms_Output", S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
    ...
    TFile fout(("OUTPUT_WN/Histograms_Output/"+folder+header+"_resultsJetsQuarksPt.root").c_str(),"recreate");
