...
void projections(int n, double r, double m, int jobs){

    stringstream header, output;
    header<<"OUTPUT/Histograms_Output/"<<n<<"_"<<r<<"_"<<m<<"_"<<jobs<<"/100M_"<<r<<"_"<<m<<"_JetsQuarksPt.root";
    output<<"OUTPUT/Histograms_Output/"<<n<<"_"<<r<<"_"<<m<<"_"<<jobs<<"/100M_"<<r<<"_"<<m<<"_projections.root";
    ...
    gm = new TGraph(nu,x,ym);
    gm->SetTitle("Mean jet p_{T} as a function of quark p_{T};quark-p_{T} [GeV/c];jet-p_{T} [GeV/c]");
    gm->SetName("graph_acjqpt_mean");
    
    gs = new TGraph(nu,x,ys);
    gs->SetTitle("Jet resolution as a function of quark p_{T};quark-p_{T} [GeV/c];#sigma [GeV/c]");
    gs->SetName("graph_acjqpt_sigma");
    ...
    gm = new TGraph(nu,x,ym);
    gm->SetTitle("Mean jet p_{T} as a function of quark p_{T};quark-p_{T} [GeV/c];jet-p_{T} [GeV/c]");
    gm->SetName("graph_sjqpt_mean");
    
    gs = new TGraph(nu,x,ys);
    gs->SetTitle("Jet resolution as a function of quark p_{T};quark-p_{T} [GeV/c];#sigma [GeV/c]");
    gs->SetName("graph_sjqpt_sigma");
    ...
    gm = new TGraph(nu,x,ym);
    gm->SetTitle("Mean jet p_{T} as a function of quark p_{T};quark-p_{T} [GeV/c];jet-p_{T} [GeV/c]");
    gm->SetName("graph_asjqpt_mean");
    
    gs = new TGraph(nu,x,ys);
    gs->SetTitle("Jet resolution as a function of quark p_{T};quark-p_{T} [GeV/c];#sigma [GeV/c]");
    gs->SetName("graph_asjqpt_sigma");
