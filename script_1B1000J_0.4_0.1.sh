...
#SBATCH --ntasks=1
#SBATCH --array=1-1000
#SBATCH --output=output_1M1000J_0.4_0.1_%a.out
#SBATCH --error=errors_1M1000J_0.4_0.1_%a.err
...
mv output_1M1000J_0.4_0.1_$SLURM_ARRAY_TASK_ID.out logs_1B_0.4_0.1_1000/
mv errors_1M1000J_0.4_0.1_$SLURM_ARRAY_TASK_ID.err logs_1B_0.4_0.1_1000/
