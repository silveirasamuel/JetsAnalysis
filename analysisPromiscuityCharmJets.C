...
void analysisPromiscuityCharmJets(string folder){
    ...
    TFile fout(("OUTPUT/Histograms Output/"+folder+"_resultsPromiscuityCharmJets.root").c_str(),"recreate");


    TH1F *hCharmQuarkPromiscuity = new TH1F("cqp","Charm Quarks Promiscuity;charms; charmed jets",15,1,1);
    TH1F *hCharmJetPromiscuity = new TH1F("cjp","Charm Jets Promiscuity;charmed jets; charms",15,1,1);

    TH1F *hAntiCharmQuarkPromiscuity = new TH1F("acqp","AntiCharm Quarks Promiscuity;anticharms; anticharmed jets",15,1,1);
    TH1F *hAntiCharmJetPromiscuity = new TH1F("acjp","AntiCharm Jets Promiscuity;anticharmed jets; anticharms",15,1,1);

    TH1F *hStrangeQuarkPromiscuity = new TH1F("sqp","Strange Quarks Promiscuity;stranges; strange jets",15,1,1);
    TH1F *hStrangeJetPromiscuity = new TH1F("sjp","Strange Jets Promiscuity;strange jets; stranges",15,1,1);

    TH1F *hAntiStrangeQuarkPromiscuity = new TH1F("asqp","AntiStrange Quarks Promiscuity;antistranges; antistrange jets",15,1,1);
    TH1F *hAntiStrangeJetPromiscuity = new TH1F("asjp","AntiStrange Jets Promiscuity;antistrange jets; antistranges",15,1,1);

    TH1F *hQuarkPromiscuity = new TH1F("qp","Quarks Promiscuity;quarks;jets",15,1,1);
    TH1F *hJetPromiscuity = new TH1F("jp","Jets Promiscuity; jets; quarks",15,1,1);
    ...
    cout<<"Histogram is built and available in: OUTPUT/Histograms Output/"<<folder<<"_resultsPromiscuityCharmJets.root"<<endl;
}