#!/bin/bash
#SBATCH --job-name=CSJets_10M10J_0.4_0.15
#SBATCH --time=4-00:00:00
#SBATCH --ntasks=1
#SBATCH --array=1-10
#SBATCH --output=output_1M10J_0.4_0.15_%a.out
#SBATCH --error=errors_1M10J_0.4_0.15_%a.err
...
mkdir -p logs_10M_0.4_0.15_10
mv output_1M10J_0.4_0.15_$SLURM_ARRAY_TASK_ID.out logs_10M_0.4_0.15_10/
mv errors_1M10J_0.4_0.15_$SLURM_ARRAY_TASK_ID.err logs_10M_0.4_0.15_10/
